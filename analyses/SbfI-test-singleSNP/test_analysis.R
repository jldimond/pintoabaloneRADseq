...
snpset0.1 <- snpgdsLDpruning(genofile, ld.threshold=0.1, autosome.only=FALSE, verbose=FALSE)
snpset0.2 <- snpgdsLDpruning(genofile, ld.threshold=0.2, autosome.only=FALSE, verbose=FALSE)
snpset0.3 <- snpgdsLDpruning(genofile, ld.threshold=0.3, autosome.only=FALSE, verbose=FALSE)
snpset0.4 <- snpgdsLDpruning(genofile, ld.threshold=0.4, autosome.only=FALSE, verbose=FALSE)
snpset0.5 <- snpgdsLDpruning(genofile, ld.threshold=0.5, autosome.only=FALSE, verbose=FALSE)
snpset0.6 <- snpgdsLDpruning(genofile, ld.threshold=0.6, autosome.only=FALSE, verbose=FALSE)
snpset0.7 <- snpgdsLDpruning(genofile, ld.threshold=0.7, autosome.only=FALSE, verbose=FALSE)
snpset0.8 <- snpgdsLDpruning(genofile, ld.threshold=0.8, autosome.only=FALSE, verbose=FALSE)
snpset0.9 <- snpgdsLDpruning(genofile, ld.threshold=0.9, autosome.only=FALSE, verbose=FALSE)
snpset1 <- snpgdsLDpruning(genofile, ld.threshold=1, autosome.only=FALSE, verbose=FALSE)
